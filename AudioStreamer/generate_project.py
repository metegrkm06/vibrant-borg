#!/usr/bin/env python3
"""
Generates a minimal AudioStreamerApp.xcodeproj/project.pbxproj
...
sources_dir = "ios/AudioStreamerApp"
swift_files = []
...
{file_refs}
{plist_ref}
\t\t{TARGET_ID}PRODUCT /* AudioStreamerApp.app */ = {{isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = AudioStreamerApp.app; sourceTree = BUILT_PRODUCTS_DIR; }};
...
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t{TARGET_ID}PRODUCT /* AudioStreamerApp.app */,
\t\t\t);
\t\t\tname = Products;
\t\t\tsourceTree = "<group>";
\t\t}};
...
\t\t{TARGET_ID} /* AudioStreamerApp */ = {{
\t\t\tisa = PBXNativeTarget;
\t\t\tbuildConfigurationList = {CONFIG_LIST_TGT} /* Build configuration list for PBXNativeTarget "AudioStreamerApp" */;
\t\t\tbuildPhases = (
...
\t\t\tdependencies = (
\t\t\t);
\t\t\tname = AudioStreamerApp;
\t\t\tproductName = AudioStreamerApp;
\t\t\tproductReference = {TARGET_ID}PRODUCT /* AudioStreamerApp.app */;
...
\t\t}};
\t\t{CONFIG_LIST_TGT} /* Build configuration list for PBXNativeTarget "AudioStreamerApp" */ = {{
\t\t\tisa = XCConfigurationList;
\t\t\tbuildConfigurations = (
\t\t\t\t{CONFIG_DEBUG_TGT} /* Debug */,
\t\t\t\t{CONFIG_REL_TGT} /* Release */,
...
os.makedirs("AudioStreamerApp.xcodeproj", exist_ok=True)
with open("AudioStreamerApp.xcodeproj/project.pbxproj", "w") as f:
    f.write(pbxproj)
